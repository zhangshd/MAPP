...
LastEditTime: 2024-09-03 13:15:38
'''
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--dl_sampler', type=str)
    parser.add_argument('--augment', action='store_true')
    # parser.add_argument('--tasks', nargs='+', default=['AdsCO2', 'AdsN2'], type=str)
    # parser.add_argument('--task_types', nargs='+', default=['regression', 'regression'], type=str)
